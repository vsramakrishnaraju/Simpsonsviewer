//
//  WireCharactersListViewController.swift
//  Simpsonsviewer
//
...
class WireCharactersListViewController: UITableViewController, UISearchResultsUpdating {
    ...
    override func viewDidLoad() {
        ...
        searchController.searchBar.placeholder = "The Wire Characters"
        navigationItem.searchController = searchController
        definesPresentationContext = true
    }

    func fetchCharacters() {
        guard let url = URL(string: "https://api.duckduckgo.com/?q=the+wire+characters&format=json") else {
            return
        }
